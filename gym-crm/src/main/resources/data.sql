...
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Olim', 'Karimov', 'olim.karimov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Sardor', 'Tursunov', 'sardor.tursunov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Bekzod', 'Mahmudov', 'bekzod.mahmudov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Jasur', 'Norboyev', 'jasur.norboyev', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Alisher', 'Qodirov', 'alisher.qodirov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Aziz', 'Murodov', 'aziz.murodov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Javohir', 'Sattorov', 'javohir.sattorov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDgym_crmsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Rustam', 'Ergashev', 'rustam.ergashev', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Shahzod', 'Islomov', 'shahzod.islomov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
INSERT INTO users (firstname, lastname, username, password, is_active) VALUES ('Dilshod', 'Sobirov', 'dilshod.sobirov', '$2a$12$91IwHVuB3FQ2Y93yC2.iteq/vnBfbIEvH.GR4WlsE0AuMYaDsuDv2', true);
